        ...
        <ul role="list" class="divide-y divide-gray-200">
            <draggable v-model="tasks" @end="updateItemOrder">
                <li v-for="task in tasks">
                                    ...
                                    <div class="hidden md:block">
                                        <div class="float-right">
                                            ...
                                            <p class="mt-2 flex items-center text-sm text-gray-500">
                                                ...
                                                <span v-else-if="task.status.name === 'Complete'">
                                                    <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                                                    </svg>
                                                </span>
                                                <span v-else-if="task.status.name === 'Pending'">
                    ...
                    <task-modal-component :showModal="showModal" :id="task.id" :action='action' @click="hideModal"></task-modal-component>
                </li>
            </draggable>
        </ul>
    </div>
